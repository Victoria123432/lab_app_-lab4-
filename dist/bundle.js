      ...
      /***/ (
        ...
        function getScrollParent(node) {
          ...
          return getScrollParent(
            (0, _getParentNode_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
              node,
            ),
          );
        }
...
*/
  ...
  \************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        var Library = /** @class */ (function () {
          ...
          Library.prototype.removeItem = function (index) {
            if (index >= 0 && index < this.items.length) {
              this.items.splice(index, 1);
            }
          };
          Library.prototype.findItem = function (callback) {
  ...
  \**********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var ModalManager = /** @class */ (function () {
          ...
          ModalManager.prototype.open = function (modalId) {
          ...
          ModalManager.prototype.setModalContent = function (modalId, content) {
            var modalBody = document.querySelector(
              "#".concat(modalId, " .modal-body"),
            );
            if (modalBody) {
        ...
        var Book = /** @class */ (function () {
          ...
          Book.prototype.getDetails = function () {
            return ""
              ...
              .concat(this.author, " \u0443 ")
              .concat(this.year, " \u0440\u043E\u0446\u0456");
          };
          return Book;
        })();
        exports.Book = Book;
        var User = /** @class */ (function () {
          function User(name, email, borrowedBookCount, borrowedBooks) {
            if (borrowedBookCount === void 0) {
              borrowedBookCount = 0;
            }
            if (borrowedBooks === void 0) {
              borrowedBooks = [];
            }
            this.name = name;
            this.email = email;
          ...
          User.prototype.getInfo = function () {
            return "Name: "
              .concat(this.name, ", Borrowed Books: ")
              .concat(this.borrowedBooks.length);
          };
          User.prototype.canBorrowMoreBooks = function () {
          ...
          User.prototype.returnBook = function (book) {
            this.borrowedBookCount--;
            this.borrowedBooks = this.borrowedBooks.filter(function (b) {
              return b !== book;
            });
          };
          return User;
  ...
  \***************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        var YearValidator = /** @class */ (function () {
          function YearValidator() {
            this.message = "Введіть коректний рік";
          }
          YearValidator.prototype.validate = function (value) {
            var currentYear = new Date().getFullYear();
            var isValidFormat = /^\d{4}$/.test(value);
            if (!isValidFormat) {
              return false;
            }
        ...
        var ValidatorSelector = /** @class */ (function () {
          ...
          ValidatorSelector.select = function (validationType) {
            return this.validators[validationType];
          };
          ValidatorSelector.validators =
            ((_a = {}),
            (_a[ValidationType.Required] = new RequiredValidator()),
            (_a[ValidationType.Number] = new NumberValidator()),
            (_a[ValidationType.Year] = new YearValidator()),
            _a);
          return ValidatorSelector;
        })();
        var FormValidator = /** @class */ (function () {
          function FormValidator() {}
          FormValidator.prototype.validateForm = function (formId) {
            ...
            inputs.forEach(function (input) {
              var _a;
              var validationTypes =
                (_a = input.getAttribute("data-validation")) === null ||
                _a === void 0
                  ? void 0
                  : _a.split(",");
              var value = input.value;
              validationTypes.forEach(function (validationType) {
                var validator = ValidatorSelector.select(validationType);
                if (!validator.validate(value)) {
                  isValid = false;
                  var errorElement = document.getElementById(
                    "".concat(input.id, "-error"),
                  );
                  if (errorElement) {
  ...
  \********************/
    ...
    var validation_1 = __webpack_require__(
      /*! ./validation */ "./src/validation.ts",
    );
    var modal_1 = __webpack_require__(/*! ./modal */ "./src/modal.ts");
    var App = /** @class */ (function () {
      function App() {
        this.bookLibrary = new library_1.Library();
        this.userLibrary = new library_1.Library();
        this.storage = new services_1.LocalStorageService();
        this.modalManager = new modal_1.ModalManager();
        this.formValidator = new validation_1.FormValidator();
        this.loadBooks();
        this.loadUsers();
      ...
      App.prototype.loadBooks = function () {
        var _this = this;
        var savedBooks = this.storage.getItem("books");
        if (savedBooks) {
          savedBooks.forEach(function (bookData) {
            var book = new models_1.Book(
              bookData.title,
              bookData.author,
              bookData.year,
              bookData.isBorrowed,
            ...
            _this.bookLibrary.addItem(book);
          });
          this.renderBookList();
        }
      };
      App.prototype.loadUsers = function () {
        var _this = this;
        var savedUsers = this.storage.getItem("users");
        if (savedUsers) {
          savedUsers.forEach(function (userData) {
            var borrowedBooks = userData.borrowedBooks.map(function (bookData) {
              var book = new models_1.Book(
                bookData.title,
                bookData.author,
                bookData.year,
            ...
            _this.userLibrary.addItem(user);
          });
          this.renderUserList();
        }
      };
      App.prototype.saveUsers = function () {
        var usersToSave = this.userLibrary.getItems().map(function (user) {
          return {
            name: user.name,
            email: user.email,
            borrowedBookCount: user.borrowedBookCount,
            borrowedBooks: user.borrowedBooks.map(function (book) {
              return {
                title: book.title,
                author: book.author,
                year: book.year,
      ...
      App.prototype.saveBooks = function () {
        var booksToSave = this.bookLibrary.getItems().map(function (book) {
          return {
            title: book.title,
            author: book.author,
            year: book.year,
      ...
      App.prototype.setupEventListeners = function () {
        var _this = this;
        var _a;
        (_a = document.getElementById("saveButton")) === null || _a === void 0
          ? void 0
          : _a.addEventListener("click", function () {
              var bookIndex = parseInt(
                document
                  .getElementById("saveButton")
                  .getAttribute("data-index"),
              );
              var userInput = document.getElementById("user-id");
              var isValid = _this.formValidator.validateForm("id-form");
              if (isValid) {
                var userId = parseInt(userInput.value);
                var book = _this.bookLibrary.getItems()[bookIndex];
                var user = _this.userLibrary.getItems()[userId];
                _this.modalManager.setModalContent(
                  "exampleModalToggle2",
                  ""
                    .concat(book.title, " has been borrowed by ")
                    .concat(user.name),
                );
                _this.borrowBook(bookIndex, userId);
                userInput.value = "";
                _this.modalManager.close("exampleModal");
                _this.modalManager.open("exampleModalToggle2");
              }
            });
      };
      App.prototype.renderBookList = function () {
        var bookList = document.getElementById("book-list-items");
        bookList.innerHTML = "";
        this.bookLibrary.getItems().forEach(function (book, index) {
          ...
          var buttonAttributes = book.isBorrowed
            ? 'data-user-id="'.concat(
                book.borrowedBy,
                '" data-bs-target="#exampleModalToggle2"',
              )
            : 'data-bs-target="#exampleModal"';
          var delButAt = book.isBorrowed ? "disabled" : "";
          listItem.innerHTML = "\n                <span>"
            .concat(book.title, " - ")
            .concat(book.author, " (")
            .concat(
              book.year,
              ')</span>\n                <div class="gap-2 d-md-flex justify-content-md-end">\n                    <button type="button" id="borrow-btn-',
            )
            .concat(index, '" class="btn ')
            .concat(buttonClass, ' borrow-btn" ')
            .concat(buttonAttributes, ' data-bs-toggle="modal" data-index="')
            .concat(index, '">')
            .concat(
              buttonText,
              '</button>\n                    <button class="delete-book-btn btn btn-danger" data-index="',
            )
            .concat(index, '" ')
            .concat(
              delButAt,
      ...
      App.prototype.setupBookEventListeners = function () {
        var _this = this;
        document.querySelectorAll(".borrow-btn").forEach(function (button) {
          button.addEventListener("click", function (event) {
            var target = event.target;
            var index = target.getAttribute("data-index");
            var bookIndex = parseInt(index);
            var book = _this.bookLibrary.getItems()[bookIndex];
            if (book.isBorrowed) {
              var userId = parseInt(target.getAttribute("data-user-id"));
              _this.modalManager.setModalContent(
                "exampleModalToggle2",
                "".concat(book.title, " has been returned"),
              );
              _this.returnBook(bookIndex, userId);
            } else {
        ...
        document
          ...
          .forEach(function (button) {
            button.addEventListener("click", function (event) {
              var target = event.target;
              var index = target.getAttribute("data-index");
              _this.bookLibrary.removeItem(parseInt(index));
              _this.storage.setItem("books", _this.bookLibrary.getItems());
              _this.renderBookList();
            });
          });
      };
      App.prototype.borrowBook = function (bookIndex, userId) {
        var book = this.bookLibrary.getItems()[bookIndex];
        var user = this.userLibrary.getItems()[userId];
      ...
      App.prototype.returnBook = function (bookIndex, userId) {
        var book = this.bookLibrary.getItems()[bookIndex];
        var user = this.userLibrary.getItems()[userId];
        if (book.isBorrowed) {
      ...
      App.prototype.renderUserList = function () {
        var userList = document.getElementById("user-list-items");
        userList.innerHTML = "";
        this.userLibrary.getItems().forEach(function (user, index) {
          var listItem = document.createElement("li");
          listItem.className = "list-group-item d-flex justify-content-between";
          listItem.innerHTML = "\n                <span>"
            .concat(user.name, " - ")
            .concat(
              user.email,
              '</span>\n                <div class="d-md-flex justify-content-md-end">\n                    <button class="delete-user-btn btn btn-danger" data-index="',
            )
            .concat(
              index,
              '">\u0412\u0438\u0434\u0430\u043B\u0438\u0442\u0438</button>\n                </div>',
      ...
      App.prototype.setupUserEventListeners = function () {
        var _this = this;
        document
          ...
          .forEach(function (button) {
            button.addEventListener("click", function (event) {
              ...
              var target = event.target;
              var index = target.getAttribute("data-index");
              var user = _this.userLibrary.getItems()[parseInt(index)];
              if (user.borrowedBookCount > 0) {
                var borrowedBooksList = user.borrowedBooks
                  .map(function (book) {
                    return book.title;
                  }) // Витягуємо поле title з кожної книги
                  .join(", "); // Об'єднуємо назви через кому
                _this.modalManager.setModalContent(
                  "exampleModalToggle2",
                  "\u0429\u043E\u0431 \u0432\u0438\u0434\u0430\u043B\u0438\u0442\u0438 \u043A\u043E\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447\u0430, \u043F\u043E\u0432\u0435\u0440\u043D\u0456\u0442\u044C: ".concat(
                    borrowedBooksList,
                    " ",
                  ),
                );
              ...
              _this.userLibrary.removeItem(parseInt(index));
              _this.storage.setItem("users", _this.userLibrary.getItems());
      ...
      App.prototype.addBook = function () {
        var _this = this;
        var _a;
        (_a = document.querySelector("#book-form")) === null || _a === void 0
          ? void 0
          : _a.addEventListener("submit", function (event) {
              ...
              var authorInput = document.querySelector(
              ...
              var isValid = _this.formValidator.validateForm("book-form");
              if (isValid) {
                var book = new models_1.Book(title, author, parseInt(year, 10));
                _this.bookLibrary.addItem(book);
                _this.modalManager.setModalContent(
                  "exampleModalToggle2",
                  "\u041A\u043D\u0438\u0436\u043A\u0443 ".concat(
      ...
      App.prototype.addUser = function () {
        var _this = this;
        var _a;
        (_a = document.querySelector("#user-form")) === null || _a === void 0
          ? void 0
          : _a.addEventListener("submit", function (event) {
              event.preventDefault();
              ...
              var isValid = _this.formValidator.validateForm("user-form");
              if (isValid) {
